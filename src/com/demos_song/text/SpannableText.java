 ...
 * 
 */
public class SpannableText extends Activity {
	public static final String TAG = "SpannableText";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_spannabletext);
		mTextView = (TextView) findViewById(R.id.tv_spannable);
		...
		msp.setSpan(new URLSpan("mailto:songzhiyong1121@gmail.com"), 39, 41,
		...
		XmlResourceParser xpplinkcolor = getResources().getXml(R.xml.color);
		try {
		...
		msp.setSpan(new TextAppearanceSpan("monospace", android.graphics.Typeface.BOLD_ITALIC, 30,
				csl, csllink), 51, 53, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		// 设置项目符号
